...
class FreePistonModelData:
    ...
    hcci_cool_flame_activation_energy_by_vol_J_per_kg: np.ndarray = field(default_factory=lambda: np.zeros(0, dtype=np.float64))
    hcci_reference_pressure_by_vol_Pa: np.ndarray = field(default_factory=lambda: np.zeros(0, dtype=np.float64))
    hcci_reference_pressure_by_vol_bar: np.ndarray = field(default_factory=lambda: np.ones(0, dtype=np.float64))
    hcci_reference_lambda_by_vol: np.ndarray = field(default_factory=lambda: np.zeros(0, dtype=np.float64))
    hcci_reference_o2_by_vol_percent: np.ndarray = field(default_factory=lambda: np.full(0, 20.94, dtype=np.float64))
    ...
    hcci_cool_flame_a_by_vol: np.ndarray = field(default_factory=lambda: np.full(0, 6.9, dtype=np.float64))
    hcci_cool_flame_m_by_vol: np.ndarray = field(default_factory=lambda: np.full(0, 2.0, dtype=np.float64))
    hcci_cool_flame_dqmax_params_by_vol: np.ndarray = field(default_factory=lambda: np.zeros((0, 6), dtype=np.float64))
    hcci_cool_flame_duration_params_by_vol: np.ndarray = field(default_factory=lambda: np.zeros((0, 6), dtype=np.float64))
    runtime_hcci_integral_by_vol: np.ndarray = field(default_factory=lambda: np.zeros(0, dtype=np.float64))
    runtime_hcci_cool_integral_by_vol: np.ndarray = field(default_factory=lambda: np.zeros(0, dtype=np.float64))
    ...
    runtime_hcci_cool_tau_by_vol_s: np.ndarray = field(default_factory=lambda: np.zeros(0, dtype=np.float64))
    runtime_cool_flame_active_by_vol: np.ndarray = field(default_factory=lambda: np.zeros(0, dtype=np.int64))
    runtime_cool_flame_done_by_vol: np.ndarray = field(default_factory=lambda: np.zeros(0, dtype=np.int64))
    runtime_cool_flame_time_by_vol_s: np.ndarray = field(default_factory=lambda: np.zeros(0, dtype=np.float64))
    runtime_cool_flame_end_time_by_vol_s: np.ndarray = field(default_factory=lambda: np.zeros(0, dtype=np.float64))
    runtime_cool_flame_energy_by_vol_J: np.ndarray = field(default_factory=lambda: np.zeros(0, dtype=np.float64))
