...
FIELD_META: dict[str, FieldMeta] = {
    ...
    "combustion.hcci_diagnostics_ref": FieldMeta("HCCI diagnostics ref", "text", default=None, help_text="Optionaler Verweis auf ein hcci_diesel-Submodell; berechnet Zuendverzug und Livengood-Wu-Integral nur als Diagnose fuer Vibe.", section="submodel", visible_if=("combustion.model", "vibe")),
