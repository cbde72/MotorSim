...
FIELD_META: dict[str, FieldMeta] = {
    ...
    "combustion.cool_flame_burn_model": FieldMeta("CF burn model", "choice", default="gamma", choices=("gamma", "beck-vibe_CF", "vibe-beck"), help_text="Ersatzbrennverlauf der Cool-Flame-Stufe: glatter Gamma-Puls oder empirischer Beck-Vibe-CF-Verlauf. vibe-beck bleibt als Alias erhalten.", section="submodel", visible_if=("combustion.cool_flame_enabled", True)),
