...
FIELD_META: dict[str, FieldMeta] = {
    ...
    "postprocessing.mode": FieldMeta("Postprocessing mode", "choice", default="pipeline", choices=("pipeline",), help_text="Nutzt die neue Postprocessing-Pipeline.", section="root"),
    "postprocessing.config": FieldMeta("Pipeline config", "text", default=None, help_text="Optionale separate YAML-Datei für postprocessing.mode = pipeline.", section="root", visible_if=("postprocessing.mode", "pipeline")),
    ...
    "postprocessing.csv_export_layout": FieldMeta("CSV export layout", "text", default="thermo0d_signal_export_layout.csv", help_text="Optionale Signal-Auswahldatei für den CSV-Export.", section="root", visible_if=("postprocessing.csv_enabled", True)),
    "postprocessing.csv_export_mode": FieldMeta("CSV export mode", "choice", default="auto", choices=("auto", "all", "selected"), help_text="auto nutzt eine vorhandene Layout-Datei, all exportiert alles, selected erzwingt die Layout-Auswahl.", section="root", visible_if=("postprocessing.csv_enabled", True)),
    "postprocessing.csv_export_missing_layout": FieldMeta("Missing layout", "choice", default="warn_all", choices=("warn_all", "fail"), help_text="Verhalten, wenn selected aktiv ist und keine Layout-Datei gefunden wird.", section="root", visible_if=("postprocessing.csv_enabled", True)),
    "postprocessing.csv_export_unknown_signals": FieldMeta("Unknown signals", "choice", default="warn_empty", choices=("warn_empty", "fail"), help_text="Verhalten bei Signalen im Layout, die im Ergebnis nicht existieren.", section="root", visible_if=("postprocessing.csv_enabled", True)),
    ...
    "postprocessing.rhs_derivatives_export.enabled": FieldMeta("RHS derivatives CSV", "bool", default=False, help_text="Zusaetzliche CSV nur mit den Zustandsableitungen dy/dt direkt aus dem RHS schreiben.", section="root"),
    "postprocessing.rhs_derivatives_export.path": FieldMeta("RHS derivatives path", "text", default=None, help_text="Optionaler Pfad der RHS-Ableitungs-CSV. Standard: Haupt-CSV mit Suffix _rhs_derivatives.csv.", section="root", visible_if=("postprocessing.rhs_derivatives_export.enabled", True)),
    ...
    "free_piston.load.motor_assist_enabled": FieldMeta("Motor assist", "bool", default=False, help_text="Aktiviert Generator-Motorbetrieb zum Anschleppen. Standard ist aus; Assist-Parameter werden nur bei true wirksam.", section="free_piston"),
    "free_piston.load.motor_assist_until_soc": FieldMeta("Assist until SOC", "bool", default=True, help_text="Schaltet den Motorassist nach dem ersten HCCI/SOC-Zeitpunkt automatisch ab.", section="free_piston", visible_if=("free_piston.load.motor_assist_enabled", True)),
    ...
    "wall_temperature.model": FieldMeta("Wall temperature model", "choice", default="none", choices=("none", "cycle_average"), help_text="Zyklusgemitteltes Wandtemperaturmodell.", section="submodel"),
    "wall_temperature.relaxation": FieldMeta("Relaxation", "float", default=0.3, help_text="Anteil der Zieltemperatur, der pro Zyklus angenähert wird.", section="submodel", visible_if=("wall_temperature.model", "cycle_average")),
    "wall_temperature.cylinder.initial_temperature_K": FieldMeta("Cylinder wall T0 [K]", "float", default=430.0, help_text="Starttemperatur der Laufbuchse.", section="submodel", visible_if=("wall_temperature.model", "cycle_average")),
    "wall_temperature.cylinder.coolant_temperature_K": FieldMeta("Cylinder coolant T [K]", "float", default=360.0, help_text="Kühlmitteltemperatur der Laufbuchse.", section="submodel", visible_if=("wall_temperature.model", "cycle_average")),
    "wall_temperature.cylinder.lambda_W_per_mK": FieldMeta("Cylinder lambda", "float", default=45.0, help_text="Wärmeleitfähigkeit der Laufbuchse.", section="submodel", visible_if=("wall_temperature.model", "cycle_average")),
    "wall_temperature.cylinder.wall_thickness_m": FieldMeta("Cylinder thickness [m]", "float", default=0.006, help_text="Effektive Wandstärke der Laufbuchse.", section="submodel", visible_if=("wall_temperature.model", "cycle_average")),
    "wall_temperature.cylinder.area_m2": FieldMeta("Cylinder area [m²]", "float", default=0.018, help_text="Gasseitige Fläche der Laufbuchse.", section="submodel", visible_if=("wall_temperature.model", "cycle_average")),
    "wall_temperature.head.initial_temperature_K": FieldMeta("Head wall T0 [K]", "float", default=470.0, help_text="Starttemperatur des Kopfs.", section="submodel", visible_if=("wall_temperature.model", "cycle_average")),
    "wall_temperature.head.coolant_temperature_K": FieldMeta("Head coolant T [K]", "float", default=370.0, help_text="Kühlmitteltemperatur des Kopfs.", section="submodel", visible_if=("wall_temperature.model", "cycle_average")),
    "wall_temperature.head.lambda_W_per_mK": FieldMeta("Head lambda", "float", default=160.0, help_text="Wärmeleitfähigkeit des Kopfs.", section="submodel", visible_if=("wall_temperature.model", "cycle_average")),
    "wall_temperature.head.wall_thickness_m": FieldMeta("Head thickness [m]", "float", default=0.010, help_text="Effektive Wandstärke des Kopfs.", section="submodel", visible_if=("wall_temperature.model", "cycle_average")),
    "wall_temperature.head.area_m2": FieldMeta("Head area [m²]", "float", default=0.008, help_text="Gasseitige Kopffläche.", section="submodel", visible_if=("wall_temperature.model", "cycle_average")),
    "wall_temperature.piston.initial_temperature_K": FieldMeta("Piston wall T0 [K]", "float", default=500.0, help_text="Starttemperatur des Kolbenbodens.", section="submodel", visible_if=("wall_temperature.model", "cycle_average")),
    "wall_temperature.piston.coolant_temperature_K": FieldMeta("Piston coolant T [K]", "float", default=390.0, help_text="Effektive Öl-/Rückseitentemperatur des Kolbens.", section="submodel", visible_if=("wall_temperature.model", "cycle_average")),
    "wall_temperature.piston.lambda_W_per_mK": FieldMeta("Piston lambda", "float", default=160.0, help_text="Wärmeleitfähigkeit des Kolbens.", section="submodel", visible_if=("wall_temperature.model", "cycle_average")),
    "wall_temperature.piston.wall_thickness_m": FieldMeta("Piston thickness [m]", "float", default=0.012, help_text="Effektive Wandstärke des Kolbenbodens.", section="submodel", visible_if=("wall_temperature.model", "cycle_average")),
    ...
    "combustion.hcci_diagnostics_ref": FieldMeta("HCCI diagnostics ref", "text", default=None, help_text="Optionaler Verweis auf ein ignition-Submodell; alte hcci_diesel-Combustion-Refs funktionieren weiter. Berechnet Zuendverzug und Livengood-Wu-Integral nur als Diagnose fuer Vibe.", section="submodel", visible_if=("combustion.model", "vibe")),
    "combustion.fueling_mode": FieldMeta("Fueling mode", "choice", default="fixed_energy", choices=("fixed_energy", "lambda_from_cylinder_mass_at_slot_close", "lambda_from_cylinder_air_at_slot_close_vapor_injector"), help_text="Art der Kraftstoff- bzw. Energievorlage.", section="submodel", visible_if=("combustion.model", "vibe")),
    "combustion.lambda_target": FieldMeta("Lambda target", "float", default=None, help_text="Ziel-Luftverhaeltnis Lambda.", section="submodel"),
    "combustion.afr_stoich_kg_air_per_kg_fuel": FieldMeta("AFR stoich", "float", default=14.5, help_text="Stoechiometrisches Luft-Kraftstoff-Verhaeltnis.", section="submodel"),
    "combustion.combustion_efficiency_0to1": FieldMeta("Comb. efficiency", "float", default=1.0, help_text="Verbrennungswirkungsgrad 0..1.", section="submodel"),
    "combustion.injection_duration_s": FieldMeta("Injection duration [s]", "float", default=None, help_text="Einspritzdauer in Sekunden.", section="submodel"),
    "combustion.injection_duration_ms": FieldMeta("Injection duration [ms]", "float", default=None, help_text="Einspritzdauer in Millisekunden.", section="submodel"),
    "combustion.slot_open_threshold_m2": FieldMeta("Slot open threshold [m2]", "float", default=1.0e-7, help_text="Flaechenschwelle fuer Schlitz offen.", section="submodel"),
    "combustion.slot_closed_threshold_m2": FieldMeta("Slot closed threshold [m2]", "float", default=1.0e-9, help_text="Flaechenschwelle fuer Schlitz geschlossen.", section="submodel"),
    "combustion.compression_velocity_threshold_m_per_s": FieldMeta("Compression v min [m/s]", "float", default=0.02, help_text="Mindest-Kompressionsgeschwindigkeit fuer Latch/Trigger.", section="submodel"),

    "combustion.ignition_model": FieldMeta("Ignition model", "choice", default="livengood_wu", choices=("livengood_wu", "beck_2003_1_arrhenius", "beck_2003_two_stage", "tabulated_livengood_wu"), help_text="HCCI-Zuendverzugsmodell: generisches Livengood-Wu, Beck 2003 oder tabellierter Zuendverzug aus NPZ.", section="submodel", visible_if=("combustion.model", "hcci_diesel")),
    ...
    "combustion.ignition_delay_table_npz": FieldMeta("Ignition table", "text", default=None, help_text="NPZ mit Temperatur_K, Druck_bar, Lambda/Phi, EGR_Rate und Zuendverzug_s fuer tabelliertes Livengood-Wu.", section="submodel", visible_if=("combustion.ignition_model", "tabulated_livengood_wu")),
    "combustion.tau_A_s": FieldMeta("Tau A [s]", "float", default=2.5e-6, help_text="Vorfaktor der Livengood-Wu-Zuendverzugszeit.", section="submodel"),
    "combustion.tau_pressure_exponent": FieldMeta("Tau p exponent", "float", default=1.2, help_text="Druckexponent des Zuendverzugsmodells.", section="submodel"),
    "combustion.tau_activation_temperature_K": FieldMeta("Tau activation T [K]", "float", default=15000.0, help_text="Aktivierungstemperatur des Zuendverzugsmodells.", section="submodel"),
    "combustion.tau_reference_pressure_Pa": FieldMeta("Tau p ref [Pa]", "float", default=1000000.0, help_text="Referenzdruck fuer das Zuendverzugsmodell.", section="submodel"),
    "combustion.tau_reference_lambda": FieldMeta("Tau lambda ref", "float", default=1.4, help_text="Referenz-Lambda fuer das Zuendverzugsmodell.", section="submodel"),
    "combustion.lambda_slowdown_exponent": FieldMeta("Lambda slowdown exp", "float", default=0.7, help_text="Lambda-Abmagerungsfaktor fuer HCCI-Verzug.", section="submodel"),
    "combustion.residual_slowdown_factor": FieldMeta("Residual slowdown", "float", default=1.5, help_text="Verlangsamung durch Restgasanteil.", section="submodel"),
    ...
    "combustion.accumulation_start_mode": FieldMeta("LW start mode", "choice", default="compression", choices=("compression", "piston_distance_from_tdc"), help_text="Startfenster fuer HCCI-Zuendverzug und Livengood-Wu-Akkumulation.", section="submodel", visible_if=("combustion.model", "hcci_diesel")),
    "combustion.accumulation_start_distance_from_tdc_mm": FieldMeta("LW start dTDC [mm]", "float", default=None, help_text="Starte HCCI-Zuendverzug/Livengood-Wu erst ab diesem Kolbenabstand vor OT.", section="submodel", visible_if=("combustion.accumulation_start_mode", "piston_distance_from_tdc")),
    "combustion.accumulation_start_distance_from_tdc_m": FieldMeta("LW start dTDC [m]", "float", default=None, help_text="SI-Alternative zu accumulation_start_distance_from_tdc_mm.", section="submodel", visible_if=("combustion.accumulation_start_mode", "piston_distance_from_tdc")),
    "combustion.accumulation_end_mode": FieldMeta("LW end mode", "choice", default="none", choices=("none", "combustion_end"), help_text="Optionale Schlussbedingung fuer die HCCI-Diagnose/Akkumulation.", section="submodel", visible_if=("combustion.model", "hcci_diesel")),
    ...
    "combustion.cool_flame_burn_model": FieldMeta("CF burn model", "choice", default="gamma", choices=("gamma", "vibe-beck_CF", "vibe-beck"), help_text="Ersatzbrennverlauf der Cool-Flame-Stufe: glatter Gamma-Puls oder empirischer Vibe-Beck-CF-Verlauf. vibe-beck bleibt als Alias erhalten.", section="submodel", visible_if=("combustion.cool_flame_enabled", True)),
    ...
    "combustion.start_temperature_min_K": FieldMeta("Start T min [K]", "float", default=780.0, help_text="Mindesttemperatur fuer HCCI-SOC.", section="submodel", visible_if=("combustion.model", "hcci_diesel")),
    "combustion.start_pressure_min_Pa": FieldMeta("Start p min [Pa]", "float", default=2000000.0, help_text="Mindestdruck fuer HCCI-SOC.", section="submodel", visible_if=("combustion.model", "hcci_diesel")),
    "combustion.max_ignition_delay_s": FieldMeta("Max ignition delay [s]", "float", default=0.02, help_text="Maximal erlaubter HCCI-Zuendverzug.", section="submodel", visible_if=("combustion.model", "hcci_diesel")),

    "ignition.model": FieldMeta("Ignition model", "choice", default="livengood_wu", choices=("livengood_wu", "beck_2003_1_arrhenius", "beck_2003_two_stage", "tabulated_livengood_wu"), help_text="Eigenes Zündverzugsmodell für HCCI.", section="submodel"),
    "ignition.ignition_delay_table_npz": FieldMeta("Ignition table", "text", default=None, help_text="NPZ mit Temperatur_K, Druck_bar, Lambda/Phi, EGR_Rate und Zuendverzug_s fuer tabelliertes Livengood-Wu.", section="submodel"),
    "ignition.tau_A_s": FieldMeta("Tau A [s]", "float", default=2.5e-6, help_text="Vorfaktor der Livengood-Wu-Zuendverzugszeit.", section="submodel"),
    "ignition.tau_pressure_exponent": FieldMeta("Tau p exponent", "float", default=1.2, help_text="Druckexponent des Zuendverzugsmodells.", section="submodel"),
    "ignition.tau_activation_temperature_K": FieldMeta("Tau activation T [K]", "float", default=15000.0, help_text="Aktivierungstemperatur des Zuendverzugsmodells.", section="submodel"),
    "ignition.tau_activation_energy_J_per_kg": FieldMeta("Activation energy [J/kg]", "float", default=None, help_text="Optionale Aktivierungsenergie je Masse.", section="submodel"),
    "ignition.tau_reference_pressure_Pa": FieldMeta("Tau p ref [Pa]", "float", default=1000000.0, help_text="Referenzdruck fuer das Zuendverzugsmodell.", section="submodel"),
    "ignition.tau_reference_lambda": FieldMeta("Tau lambda ref", "float", default=1.4, help_text="Referenz-Lambda fuer das Zuendverzugsmodell.", section="submodel"),
    "ignition.lambda_slowdown_exponent": FieldMeta("Lambda slowdown exp", "float", default=0.7, help_text="Lambda-Abmagerungsfaktor fuer HCCI-Verzug.", section="submodel"),
    "ignition.residual_slowdown_factor": FieldMeta("Residual slowdown", "float", default=1.5, help_text="Verlangsamung durch Restgasanteil.", section="submodel"),
    "ignition.beck_c1_s": FieldMeta("Beck c1 [s]", "float", default=1.0e-5, help_text="Beck 1-Arrhenius Vorfaktor c1 der Zuendverzugszeit.", section="submodel"),
    "ignition.beck_c2": FieldMeta("Beck c2", "float", default=-1.2, help_text="Beck Druckexponent c2 in (p/p0)^c2.", section="submodel"),
    "ignition.beck_reference_pressure_bar": FieldMeta("Beck p0 [bar]", "float", default=1.0, help_text="Beck Referenzdruck p0 fuer den Druckterm.", section="submodel"),
    "ignition.beck_reference_o2_percent": FieldMeta("Beck O2 air [%]", "float", default=20.94, help_text="Sauerstoffkonzentration trockener Luft fuer den linearen O2-Term nach Beck.", section="submodel"),
    "ignition.beck_cf_fuel_name": FieldMeta("Beck CF fuel", "choice", default="Diesel 2", choices=BECK_COOL_FLAME_FUEL_NAMES, help_text="Kraftstoffname nach Beck Tabelle 6.2 fuer die Cool-Flame-Parametersaetze.", section="submodel"),
    "ignition.cool_flame_enabled": FieldMeta("Cool flame", "bool", default=False, help_text="Aktiviert separate Cool-Flame-Stufe vor der Hot-Flame-Hauptverbrennung.", section="submodel"),
    "ignition.cool_flame_burn_model": FieldMeta("CF burn model", "choice", default="gamma", choices=("gamma", "vibe-beck_CF", "vibe-beck"), help_text="Ersatzbrennverlauf der Cool-Flame-Stufe.", section="submodel"),
    "ignition.cool_flame_energy_fraction": FieldMeta("CF energy fraction", "float", default=0.08, help_text="Anteil der Zyklusenergie, der in der Cool-Flame-Stufe freigesetzt wird.", section="submodel"),
    "ignition.cool_flame_duration_ms": FieldMeta("CF duration [ms]", "float", default=0.3409, help_text="Zeitdauer des Cool-Flame-Vibe-Ersatzbrennverlaufs.", section="submodel"),
    "ignition.start_temperature_min_K": FieldMeta("Start T min [K]", "float", default=780.0, help_text="Mindesttemperatur fuer HCCI-SOC.", section="submodel"),
    "ignition.start_pressure_min_Pa": FieldMeta("Start p min [Pa]", "float", default=2000000.0, help_text="Mindestdruck fuer HCCI-SOC.", section="submodel"),
    "ignition.max_ignition_delay_s": FieldMeta("Max ignition delay [s]", "float", default=0.02, help_text="Maximal erlaubter HCCI-Zuendverzug.", section="submodel"),
    "ignition.accumulation_start_mode": FieldMeta("LW start mode", "choice", default="compression", choices=("compression", "piston_distance_from_tdc"), help_text="Startfenster fuer HCCI-Zuendverzug und Livengood-Wu-Akkumulation.", section="submodel"),
    "ignition.accumulation_start_distance_from_tdc_mm": FieldMeta("LW start dTDC [mm]", "float", default=None, help_text="Starte HCCI-Zuendverzug/Livengood-Wu erst ab diesem Kolbenabstand vor OT.", section="submodel"),
    "ignition.accumulation_start_distance_from_tdc_m": FieldMeta("LW start dTDC [m]", "float", default=None, help_text="SI-Alternative zu accumulation_start_distance_from_tdc_mm.", section="submodel"),
    "ignition.accumulation_end_mode": FieldMeta("LW end mode", "choice", default="none", choices=("none", "combustion_end"), help_text="Optionale Schlussbedingung fuer die HCCI-Diagnose/Akkumulation.", section="submodel"),
...
def meta_for(key: str) -> FieldMeta | None:
    if key.startswith("combustion.ignition."):
        return FIELD_META.get("ignition." + key[len("combustion.ignition."):])
