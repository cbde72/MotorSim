...
def main(args_list: list[str] | None = None) -> int:
    ...
    plots_enabled = bool(plot_cfg.get("enabled", True)) if args.plots is None else bool(args.plots)
    if plots_enabled and artifacts.csv_path:
        ...
        last_plot_cfg = plot_cfg.get("last_ut_ot_ut") if isinstance(plot_cfg.get("last_ut_ot_ut"), dict) else {}
        if bool(last_plot_cfg.get("enabled", False)) and artifacts.last_ut_ot_ut_csv_path:
