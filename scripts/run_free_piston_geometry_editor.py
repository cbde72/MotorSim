...
from thermo0d.gui.free_piston_geometry_editor import main as gui_main


def parse_args(args_list: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Launcher for thermo0d FreePistonGeometryEditor")
